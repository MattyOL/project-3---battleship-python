...
struck, and will finish with a lowercase "s" when finihsed. If the location of were the user guessed is wrong the symbol will be marked with a capital "X" to show users attempt.
